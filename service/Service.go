...
type Service struct {
	...
	Spec            meta.ServiceSpec   `json:"spec,omitempty" protobuf:"bytes,2,opt,name=spec" :"spec"`
	Status          meta.ServiceStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status" :"status"`
}
